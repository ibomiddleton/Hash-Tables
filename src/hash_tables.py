...
def how_many_before_collision(buckets, loops=1):
    ...
    * A bucket is an unspecified amount of data
    '''
...
how_many_before_collision(1080, 10)

def longest_linked_list_chain(keys, buckets, loops=10):
    '''
    Rolls 'keys' number of random keys into buckets, buckets and count the collison.
